  ...
  function openCreateTeamModal() {
    ...
    BR.ui.openModal('createTeamModal', {
      ...
      bodyHTML: `
        ...
        <input class="input" id="captainIgn" value="${escapeHtml(profile?.username && profile.username !== 'Guest Warrior' ? profile.username : '')}" style="margin-bottom:12px">
        ...
        <select class="select" id="captainRole" style="margin-bottom:20px">
          <option value="IGL">IGL (In-Game Leader)</option><option value="RUSHER">Rusher</option>
