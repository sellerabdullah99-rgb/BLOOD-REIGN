...
BR.mockData = {
  ...
  // Demo "who's registered" data — only used when Supabase isn't configured,
  // so the registry UI has something to show in offline/demo mode too.
  tournamentParticipants: {
    t1: { players: [ // SOLO
      { username: 'xXBloodKingXx', ff_uid: '10234567' },
      { username: 'KarachiSniper', ff_uid: '10298345' },
      { username: 'NightOwlPK', ff_uid: '10387234' },
    ] },
    t2: { teams: [ // SQUAD
      { name: 'Karachi Titans', tag: 'KT', roster: [{ ign: 'TitanLead', role: 'IGL' }, { ign: 'TitanRush', role: 'RUSHER' }, { ign: 'TitanAim', role: 'ASSAULTER' }, { ign: 'TitanScope', role: 'SNIPER' }] },
      { name: 'Lahore Wolves', tag: 'LWX', roster: [{ ign: 'WolfHowl', role: 'IGL' }, { ign: 'WolfFang', role: 'RUSHER' }, { ign: 'WolfClaw', role: 'ASSAULTER' }, { ign: 'WolfEye', role: 'SNIPER' }] },
    ] },
    t3: { teams: [ // DUO
      { name: 'Desert Hawks', tag: 'DHK', roster: [{ ign: 'HawkOne', role: 'IGL' }, { ign: 'HawkTwo', role: 'ASSAULTER' }] },
    ] },
    t4: { players: [ // SOLO
      { username: 'FreeFire_Zain', ff_uid: '10456789' },
    ] },
    t5: { teams: [ // SQUAD grand final
      { name: 'Rawalpindi Reapers', tag: 'RPR', roster: [{ ign: 'ReapKing', role: 'IGL' }, { ign: 'ReapBlade', role: 'RUSHER' }, { ign: 'ReapShot', role: 'ASSAULTER' }, { ign: 'ReapScope', role: 'SNIPER' }] },
    ] },
  },

  // Demo "browse all teams" list for Scrims / Tryouts sections in offline mode.
  teams: [
    { id: 'dt1', name: 'Karachi Titans', tag: 'KT', region: 'Karachi', members: [{ ign: 'TitanLead', role: 'IGL' }, { ign: 'TitanRush', role: 'RUSHER' }, { ign: 'TitanAim', role: 'ASSAULTER' }, { ign: 'TitanScope', role: 'SNIPER' }] },
    { id: 'dt2', name: 'Lahore Wolves', tag: 'LWX', region: 'Lahore', members: [{ ign: 'WolfHowl', role: 'IGL' }, { ign: 'WolfFang', role: 'RUSHER' }, { ign: 'WolfClaw', role: 'ASSAULTER' }, { ign: 'WolfEye', role: 'SNIPER' }] },
    { id: 'dt3', name: 'Desert Hawks', tag: 'DHK', region: 'Islamabad', members: [{ ign: 'HawkOne', role: 'IGL' }, { ign: 'HawkTwo', role: 'ASSAULTER' }] },
    { id: 'dt4', name: 'Rawalpindi Reapers', tag: 'RPR', region: 'Rawalpindi', members: [{ ign: 'ReapKing', role: 'IGL' }, { ign: 'ReapBlade', role: 'RUSHER' }, { ign: 'ReapShot', role: 'ASSAULTER' }, { ign: 'ReapScope', role: 'SNIPER' }] },
  ],
